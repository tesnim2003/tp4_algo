...
1. Implémenter et tester plusieurs algorithmes de tri en langage C.
2. Calculer la complexité théorique de chaque algorithme.
3. Comparer la complexité théorique et les résultats expérimentaux.
4. Visualiser les performances des algorithmes en fonction de la taille des données.
...
1. Génération de tableaux aléatoires de tailles croissantes : n = 1000, 5000, 10000, 20000, 50000.
2. Chaque test est répété 10 fois pour obtenir une moyenne fiable.
3. Mesure du temps d’exécution en millisecondes.
4. Comparaison entre algorithmes pour différents cas : meilleur, moyen et pire cas.
